...
// sources:
// _boilerplate/functions/hello/index.js (147B)
...
func functionsHelloIndexJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "functions/hello/index.js", size: 147, mode: os.FileMode(0644), modTime: time.Unix(1599336013, 0)}
